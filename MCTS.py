...
# extension of the MCTS class from open_spiel
# returns the policy and the action chosen by the MCTS for self-play
...
class MCTS(mcts.MCTSBot):
    ...
    def step_with_policy_training(self, state, temp):
        ...
        # add the non-legal actions to the policy with 0.0 probability
